...
export const paths: Path[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      ["Git & GitHub", "Tracking changes to your code and collaborating with others without losing work."],
  ...
  },
  {
    ...
    steps: [
      ...
      ["Feature engineering", "Choosing and shaping the right inputs so your model has the best possible clues to learn from."],
  ...
  },
  {
    ...
    steps: [
      ...
      ["Git & version control", "Tracking changes to your project, which matters even more in games with lots of art and code files."],
  ...
  },
  {
    ...
    steps: [
      ...
      ["Git & GitHub", "Track your code changes and collaborate with developers using the same tools they do."],
    ],
  },
];
